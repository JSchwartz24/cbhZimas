...
function process()
    {
        ...
        var map = "https://gis.beverlyhills.org/VBHforCS/PublicwSearch/?mobileBreakPoint=5&Q=" + document.getElementById("search").value;
        var popup = "https://cs.beverlyhills.org/cs/summary.jsp?_ent=lso&_type=lso&_typeid=" + document.getElementById("search").value;
